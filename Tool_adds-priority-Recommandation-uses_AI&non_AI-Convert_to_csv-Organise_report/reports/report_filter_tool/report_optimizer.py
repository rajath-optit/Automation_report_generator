...
def main():
    # Define the input and output report files
    report_file = 'aws_compliance_benchmark_all_controls_benchmark_with_priorities.csv'
    final_report_file = 'aws_compliance_benchmark_all_controls_benchmark_final_optimized_report.csv'
